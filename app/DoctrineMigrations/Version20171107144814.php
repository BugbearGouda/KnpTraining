 ...
 */
class Version20171107144814 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user ADD last_updated_by_id INT DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user DROP last_updated_by_id, DROP updated_at');
    }
}
